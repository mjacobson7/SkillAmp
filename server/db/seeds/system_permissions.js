...
exports.seed = function (knex, Promise) {
  ...
  return knex('permissions').del().then(() => {
    ...
    return knex('permissions').insert([
      ...
      { name: 'CAN_EDIT_USERS', isAdminPermission: true, isSupervisorPermission: true, isUserPermission: false, createdAt: new Date() },
      ...
      { name: 'CAN_VIEW_SUPERVISOR_TOOLS_NAV', isAdminPermission: true, isSupervisorPermission: true, isUserPermission: false, createdAt: new Date() },
